...
arg_parser.add_argument('--data_folder', type=str, default='../',
...
arg_parser.add_argument('--init_train_data_name', type=str, default='data_raw/split1.jsonl',
	help="the filename of the original training data.")
arg_parser.add_argument('--init_dev_data_name', type=str, default='data_raw/dev.jsonl',
	help="the filename of the original dev data.")
arg_parser.add_argument('--init_test_data_name', type=str, default='data_raw/test.jsonl',
	help="the filename of the original test data.")
arg_parser.add_argument('--prep_train_data_name', type=str, default='data_preproccessed/train_plot.json',
...
arg_parser.add_argument('--prep_dev_data_name', type=str, default='data_preproccessed/dev_plot.json',
	help="the filename of the preprocessed dev data. When set to None, it means that the dev data is not preprocessed.")
arg_parser.add_argument('--prep_test_data_name', type=str, default='data_preproccessed/test_plot.json',
	help="the filename of the preprocessed test data. When set to None, it means that the test data is not preprocessed.")
arg_parser.add_argument('--prep_dev_hard_data_name', type=str, default='data_preproccessed/dev_plot_hard.json',
...
arg_parser.add_argument('--prep_test_hard_data_name', type=str, default='data_preproccessed/test_plot_hard.json',
...
arg_parser.add_argument('--nl_freq_file', type=str, default='data_preproccessed/nl_freq.json',
	help='the file that stores the frequency of each natural language word.')
arg_parser.add_argument('--code_freq_file', type=str, default='data_preproccessed/code_freq.json',
	help='the file that stores the frequency of each code token.')
arg_parser.add_argument('--nl_vocab', type=str, default='data_preproccessed/nl_vocab.json',
	help='the file that stores the natural language word vocabulary.')
arg_parser.add_argument('--code_vocab', type=str, default='data_preproccessed/code_vocab.json',
